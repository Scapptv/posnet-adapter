...
**Cari faza:** AI-2 (POS CORE) — G1 ✅ **şərti təsdiq** (2026-06-03, Scapptv); AI-1 Foundation TAM (18/18); **Faza AI-2.H TAM (H1-H5)**; **AI-2.5 ✅ KOD TƏRƏFİ TAM (5.1-5.6)**
**Cari task:** **AI-2.5 gate review (operator) → G-V validasiya**. Kod tərəfi tam: adapter kontraktı + contract test · E2E 0 oversell · reconciliation drift təpib+təmir · rate-limit+retry+DLQ · OTel sync metrik · swap-ready. Növbəti kod-işi yoxdur — gate operator təsdiqi gözləyir.
**Son commit:** `148b06d` — feat(sync): AI-2.5.6.3 OTel spans + sync metrics
**Son uğurlu verify:** 2026-06-05; AI-2.5.6.3 TAM (main suite 576 @ 98.41%; observability test 9; ruff+format+mypy+bandit+detect-secrets keçir)
**Vəziyyət:** AI-2 (2.1–2.4 ✅; **AI-2.H1-H5 ✅**; **AI-2.5.1-5.6 ✅** contract + dispatcher + mock + webhook ingress + **E2E MVP (0 oversell)** + **reconciliation** + **OTel observability**). **AI-2.5 nüvəsi tam — G-V validasiya gate-i növbəti.** GitHub `Scapptv/posnet-adapter` (public), **CI bloklu** (Q-002, operator), push pauza (lokal-only).
