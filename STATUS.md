...
**Cari task:** **AI-2.H4** (Sync change-feed — catalog/inventory/pricing outbox event emit + consume idempotency `idempotency_keys` wiring) — bax Faza AI-2.H
**Son commit:** `149e2dc` — chore: STATUS — AI-2.H2 data identity & invariant tam; növbəti AI-2.H3
**Son uğurlu verify:** 2026-06-04; AI-2.H3 TAM (406 test, coverage 99.88% lokal — honest, fake-session paint silindi)
**Vəziyyət:** AI-2 IN_PROGRESS (2.1–2.4 ✅; **AI-2.H1 ✅** + **AI-2.H2 ✅** + **AI-2.H3 ✅ anti-oversell proof**). **$100M audit** (6 agent) → **Faza AI-2.H (hardening) AI-2.5-dən ƏVVƏL** (ADR-0016); növbəti AI-2.H4. GitHub `Scapptv/posnet-adapter` (public), **CI bloklu** (hesab billing), push pauza (lokal-only).
