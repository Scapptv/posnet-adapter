...
**Cari task:** **AI-2.5.6** Reconciliation cron + OTel observability — kanal stoku vs POS drift təpib + təmir; sync metrik (lag, push success rate, DLQ depth).
**Son commit:** `94ecb89` — feat(sync): AI-2.5.5 E2E MVP inbound order ingest (main, 2.5.4 üstünə cherry-pick)
**Son uğurlu verify:** 2026-06-04; AI-2.5.5 TAM (main suite 555 @ 98.40%; order_ingest 100%; ruff+format+mypy+bandit+detect-secrets keçir)
