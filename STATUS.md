...
**Cari task:** **AI-2.H5** (Sync model enabler — store↔warehouse / online-sellable-stock + online-published flag + channel schema + canonical mapper) — bax Faza AI-2.H
**Son commit:** `e8f56c5` — chore: STATUS — AI-2.H3 anti-oversell proof tam; növbəti AI-2.H4
**Son uğurlu verify:** 2026-06-04; AI-2.H4 TAM (414 test, coverage 99.88% lokal)
**Vəziyyət:** AI-2 IN_PROGRESS (2.1–2.4 ✅; **AI-2.H1 ✅** + **AI-2.H2 ✅** + **AI-2.H3 ✅** + **AI-2.H4 ✅ sync change-feed**). **$100M audit** (6 agent) → **Faza AI-2.H (hardening) AI-2.5-dən ƏVVƏL** (ADR-0016); növbəti AI-2.H5. GitHub `Scapptv/posnet-adapter` (public), **CI bloklu** (hesab billing), push pauza (lokal-only).
