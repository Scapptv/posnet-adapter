...
**Son commit:** `284318f` — feat(pos): AI-2.8.3 reserved order -> Posnet write-back (inbound tail)
**Son uğurlu verify:** 2026-06-05; AI-2.8.3 TAM (Python **625 @ 98.2%**; ruff+format+mypy+bandit+detect-secrets keçir). G-V demo dövrəsi tam (admin-web). AI-2.5 gate: HUMAN-GATES.md (təsdiq gözləyir).
